...
public class Dual2Trial2Activity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dual2_trial2);

        bundle = getIntent().getExtras();
        String adminId = bundle.getString("ID");
        ConnectToDB.updateTrainerSessionTrial(adminId, 2, "dual",
        ...
        nextButton =  (Button) findViewById(R.id.nextButtonFromDual22);
        minusButton = (ImageButton) findViewById(R.id.minusDual22);
        plusButton = (ImageButton) findViewById(R.id.plusDual22);
        errorNumText = (EditText) findViewById(R.id.Dual2NumErrors2);
        minusButton.setOnClickListener(this);
        plusButton.setOnClickListener(this);
        nextButton.setOnClickListener(this);

        Dualword1 = (CheckedTextView) findViewById(R.id.Dual2Word1);
        Dualword2 = (CheckedTextView) findViewById(R.id.Dual2Word2);
        Dualword3 = (CheckedTextView) findViewById(R.id.Dual2Word3);
        Dualword4 = (CheckedTextView) findViewById(R.id.Dual2Word4);
        Dualword5 = (CheckedTextView) findViewById(R.id.Dual2Word5);
        numCorrectWords = (EditText) findViewById(R.id.Dual2NumCorrectWords2);
    ...
    public void onClick(View v) {
        ...
        if (v == nextButton) {
            ...
            bundle.putInt("numCorrectWordsDual22", num);
            bundle.putStringArrayList("Dual2Trial2Words", rememberedWords);

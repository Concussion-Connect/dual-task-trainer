...
public class DualTrial4Activity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dual_trial4);
        ...
        Dualword1 = (CheckedTextView) findViewById(R.id.DualWord11);
        Dualword2 = (CheckedTextView) findViewById(R.id.DualWord12);
        Dualword3 = (CheckedTextView) findViewById(R.id.DualWord13);
        Dualword4 = (CheckedTextView) findViewById(R.id.DualWord14);
        Dualword5 = (CheckedTextView) findViewById(R.id.DualWord15);
        numCorrectWords = (EditText) findViewById(R.id.errorTextForDual4);
        next = (Button) findViewById(R.id.nextFromTrial4Dual);
    ...
    public void onClick(View v) {
        ...
        if(v== next) {
            Intent intent = new Intent(this, EndDual1Activity.class);
            bundle.putStringArrayList("DualTrial4Words", rememberedWords);
            bundle.putInt("numCorrectWordsDual4", num);
